...
const score = 400;  // A number primitive. JavaScript automatically infers the type.
// console.log(score);

// Explicitly creating a Number object. This is less common and can have different behavior than primitives.
const balance = new Number(100);
// console.log(balance); // Output: [Number: 100]

// --- Number Methods ---
// These methods are called on number variables (primitives or objects).

// .toString() converts the number to its string representation.
// console.log(balance.toString().length); // Output: 3

// .toFixed(digits) formats the number to have a specified number of decimal places.
// console.log(balance.toFixed(2)); // Output: "100.00"

const otherNumber = 123.8966;

// .toPrecision(length) formats the number to a specified total number of significant digits.
// console.log(otherNumber.toPrecision(4)); // Output: "123.9" (rounds the last digit)
// console.log(otherNumber.toPrecision(3)); // Output: "124" (rounds and returns in exponential form if needed)

const hundreds = 1000000;

// .toLocaleString() formats the number according to locale-specific conventions (e.g., adding commas).
...
// It is a static object, so you always use it directly (e.g., Math.random()) without creating an instance.
...
// To get a random number in a desired range, you can use a common formula.
...
// Formula to get a random integer within a specific range (inclusive).
const min = 10;
const max = 20;

console.log(Math.floor(Math.random() * (max - min + 1)) + min); // Returns a random integer between 10 and 20.